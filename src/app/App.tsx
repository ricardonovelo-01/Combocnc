...
function LaundryControlApp() {
  ...
  return (
    <div className="relative w-full max-w-[430px] bg-white min-h-[932px] h-[932px] flex flex-col overflow-hidden shadow-2xl rounded-[20px]">
      {/* Status Bar */}
        ...
        <div className="bg-white rounded-t-[16px] shadow-[0px_-4px_12px_0px_rgba(0,0,0,0.08)] -mt-[200px] relative z-20">
          <div className="flex flex-col gap-4 px-4 pt-4 pb-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <button onClick={() => setShowCyclePicker(true)}
                className="bg-[#f2f2f2] h-[56px] w-full flex items-center justify-center rounded-[8px]">
                <span className="font-['Avenir:Medium',sans-serif] text-[16px] text-[#1a1a1a]">{cycleLabel(state.cycle)}</span>
              </button>
            </div>
